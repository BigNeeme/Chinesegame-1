  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        game: {
          table: "hsl(var(--game-table) / <alpha-value>)",
          felt: "hsl(var(--game-table-felt) / <alpha-value>)",
          rim: "hsl(var(--game-table-rim) / <alpha-value>)",
        },
        card: {
          white: "hsl(var(--card-white) / <alpha-value>)",
          red: "rgb(220 38 38)",
          black: "rgb(23 23 23)",
        },
        gold: {
      ...
      keyframes: {
        ...
        "gold-glow": {
          "0%, 100%": { boxShadow: "0 0 10px 2px rgba(234, 179, 8, 0.4)" },
          "50%": { boxShadow: "0 0 25px 5px rgba(234, 179, 8, 0.8)" },
        },
        "confetti": {
      ...
      animation: {
        ...
        "timer-countdown": "timer-countdown 30s linear forwards",
